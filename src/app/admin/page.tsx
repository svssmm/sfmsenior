    ...
    <div className="min-h-screen bg-slate-50 pt-24 pb-12 px-6">
      <div className="max-w-5xl mx-auto">
        <div className="flex justify-between items-center mb-12">
          <div>
            <h1 className="text-3xl font-bold text-sfm-dark">Admin Dashboard</h1>
            <p className="text-gray-500">Welcome back, {session.username}</p>
          </div>
          <a href="/api/logout" className="flex items-center gap-2 text-red-600 hover:text-red-700 font-medium">
            <LogOut className="w-5 h-5" /> Logout
          </a>
        </div>

        <div className="bg-blue-50 border border-blue-100 p-6 rounded-2xl mb-12 flex gap-4">
          <div className="bg-blue-500 text-white p-2 rounded-lg h-fit">
            <Plus className="w-5 h-5" />
          </div>
          <div>
            <h3 className="font-bold text-blue-900">How to use your dashboard</h3>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            <div className="flex items-center gap-3 mb-6">
              <div className="bg-sfm-mid/10 p-2 rounded-lg">
                <Bell className="w-6 h-6 text-sfm-mid" />
              </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            <div className="flex items-center gap-3 mb-6">
              <div className="bg-sfm-mid/10 p-2 rounded-lg">
                <Calendar className="w-6 h-6 text-sfm-mid" />
              </div>
        ...
        <div className="space-y-8">
          <div>
            <h2 className="text-2xl font-bold text-sfm-dark mb-4">Manage Posts</h2>
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div className="space-y-3">
                  {allEvents.map((event) => (
                    <div key={event.id} className="flex justify-between items-center p-3 bg-slate-50 rounded-lg group">
